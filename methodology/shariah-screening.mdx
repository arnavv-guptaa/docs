...
```mermaid
graph TB
    A[30,000+ Securities] --> B[Layer 1: Quant Filters]
    B --> C[Layer 2: Qual Research]
    C --> D[Layer 3: AI Synthesis]
    D --> E[Layer 4: Scholar Oversight]
    E --> F[Shariah-Compliant Universe]

    B --- B1[Automated · Weekly<br/>Debt ratios · Cash ratios<br/>Interest income · Revenue thresholds]
    C --- C1[Manual · Ongoing<br/>Business activity review<br/>Segment analysis · News monitoring]
    D --- D1[AI-Assisted · Continuous<br/>LLM analysis · Web search<br/>Cross-reference · Flag issues]
    E --- E1[Human · Quarterly<br/>Final ruling · Edge cases<br/>Annual audit]

    style A fill:#f0f0f0,stroke:#666
    style B fill:#e8f4ea,stroke:#2d6a4f
    style C fill:#e8f4ea,stroke:#2d6a4f
    style D fill:#e8f4ea,stroke:#2d6a4f
    style E fill:#e8f4ea,stroke:#2d6a4f
    style F fill:#d4edda,stroke:#155724
    style B1 fill:#fff,stroke:#ccc
    style C1 fill:#fff,stroke:#ccc
    style D1 fill:#fff,stroke:#ccc
...
**For Advisors:**
Enterprise accounts include compliance documentation templates and client-facing materials. [Contact our team](https://parallax.chicago.global/contact) to discuss advisor solutions and access to Shariah audit documentation.

**For Institutions:**
Enterprise accounts include full audit trails, custom reporting, and direct access to compliance documentation. [Request a demo](https://parallax.chicago.global/contact) to see institutional Shariah compliance features.
