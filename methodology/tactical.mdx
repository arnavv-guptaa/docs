...
<Note>
Not to be confused with [tactical asset allocation](/glossary/tactical-asset-allocation), a term used in Macro Reports for cycle-length tilts between asset classes. The Tactical factor described here operates on individual securities over days and weeks.
</Note>
