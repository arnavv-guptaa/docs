...
A single analyst can reconstruct one company's statements, estimate a bottom-up beta, build a five-year forecast and solve a reverse DCF. Doing that consistently across a global coverage universe creates a different set of problems.
