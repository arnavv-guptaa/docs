...
Outliers remain in the evidence and are flagged using relative and distributional diagnostics. They are not silently deleted or winsorized. Parallax also calculates robust and leave-one-out centers as stability diagnostics. Those diagnostics challenge the primary center. They do not quietly replace it.
