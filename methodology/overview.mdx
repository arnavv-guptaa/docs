...
<CardGroup cols={2}>
  ...
  <Card title="Valuation Framework" icon="compass" href="/methodology/valuation/overview">
    Intrinsic valuation, market expectations, peer evidence, and how a price target is governed
  </Card>
  ...
  <Card title="Macro Reports" icon="globe" href="/macro/overview">
    Weekly country and global cross-asset research that complements the security-level framework
  </Card>
  <Card title="News Intelligence" icon="newspaper" href="/methodology/news-intelligence">
    How automated event detection and scenario analysis translate breaking news into portfolio-specific impact
  </Card>
</CardGroup>
