...
<Note>
Analysis typically takes 2-5 minutes. Uses Krishna Palepu's framework for business strategy, accounting quality, and financial performance analysis.
</Note>
...
The analysis follows Krishna Palepu's framework:
...
const response = await fetch(
  'https://parallax-api.onrender.com/v1/financial-analysis?symbol=AAPL.O',
  {
    method: 'POST',
