...
- **Automated News Monitoring**: Portfolio-relevant event detection and impact assessment, including ETF look-through
...
<CardGroup cols={2}>
  ...
  <Card title="Natural Language Processing" icon="message">
    **Corporate Disclosures**: Automated monitoring of company filings and corporate announcements.

    **News Flow Analysis**: Real-time processing of financial news for market-moving events.
  </Card>
</CardGroup>
